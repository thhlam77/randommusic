...
$tracks = [
    [
        ...
        "url" => "https://files.catbox.moe/m24mqx.mp3"
    ],
    [
        "title" => "Gói gọn hồi ức trao cho anh",
        "url" => "https://files.catbox.moe/x2d0bn.mp3"
    ],
    [
        "title" => "Em biết anh không yêu em",
        "url" => "https://files.catbox.moe/wj6yz9.mp3"
    ]
];
